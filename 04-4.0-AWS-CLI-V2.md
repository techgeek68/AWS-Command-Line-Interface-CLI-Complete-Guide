...
- Locate the AWS CLI path** (default for v2):
...
Want me to also give you the **bullet-point version of the PowerShell one-liner method** (faster, no GUI)?
